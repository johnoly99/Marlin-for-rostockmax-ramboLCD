          ...
          case ItemAM_X:
          {
	 	  //oldencoderpos=0;
			...
			enquecommand("G91");
		      ...
		      enquecommand("G90");
                  ...
                  if(linechanging)
                  {
                    if (encoderpos >0) 
                   { 
		    	enquecommand("G1 F3500 X0.5");   //changed for rostock MAX
			oldencoderpos=encoderpos;
                    ...
                    {
		    	enquecommand("G1 F3500 X-0.5");  //changed for Rostock MAX
			oldencoderpos=encoderpos;
                        encoderpos=0;
		    }
                    lcd.setCursor(11,line);lcd.print(ftostr52(current_position[X_AXIS]));
